...
import { resetSelectedBook, showActionMessage, resetAllPopups } from "../store/slices/popUpSlice";
...
const EditBookPopup = () => {
  ...
  const showPopup = useSelector((state) => state.popup.editBookPopup);
  const selectedBook = useSelector((state) => state.popup.selectedBook);
  ...
  useEffect(() => {
    if (selectedBook) {
      setFormData({
        ...
        auther: selectedBook.auther || "",
        description: selectedBook.description || "",
        charge: selectedBook.charge || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.put(
        `/books/admin/updatebook/${selectedBook._id}`,
        {
      ...
      if (response.data.success) {
        ...
        dispatch(showActionMessage("Book updated successfully"));
